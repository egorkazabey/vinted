...
Оцени объявление и реши, стоит ли присылать его пользователю как выгодную находку.
...
2. Судя по приложенному фото (если оно есть), в каком состоянии вещь: есть ли видимые
   ...
   состояние не оценить, — в таких случаях не считай сделку выгодной.
...
class GeminiClient:
    """Тонкий клиент над Gemini API (generateContent) для оценки находок."""
